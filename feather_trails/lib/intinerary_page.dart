...
class ItineraryPage extends StatefulWidget {
  ...
  const ItineraryPage({required this.bucket});
  @override
...
class ItineraryPageState extends State<ItineraryPage>
  ...
  Widget build(BuildContext context) {
    super.build(context);
      ...
      imageUrl: 'https://images.unsplash.com/photo-1589405858862-2ac9cbb41321?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8M3x8fGVufDB8fHx8fA%3D%3D'
    );
    return PageStorage(
      bucket: widget.bucket,
      key: const PageStorageKey('IntineraryPage'),
      child: Scaffold(
        body: Center(
          child: Container(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ButtonStyle(
                      ...
                      minimumSize:
                          MaterialStateProperty.all(const Size(360, 48)),
