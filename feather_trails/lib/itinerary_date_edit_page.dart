...
class ItineraryDateEditPage extends StatefulWidget {
  @override
  ItineraryDateEditPageState createState() => ItineraryDateEditPageState();

}

class ItineraryDateEditPageState extends State<ItineraryDateEditPage> {
  @override
